package com.example.haoyue.onlineshoppingorderslist.View;
...
public class LeftSlideView extends HorizontalScrollView {
    private TextView mTextView_Edit;//编辑按钮
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!once) {
            mTextView_Delete = findViewById(R.id.order_item_delete);
            mTextView_Edit = findViewById(R.id.order_item_edit);
            once = true;
        }
    }
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        /**改变view的在x轴方向的位置*/
        mTextView_Edit.setTranslationX(1);
    }
